...
export const AlarmCard = ({ sender, spaceName }: Props) => {
  return (
    <div className="flex flex-col gap-2.5 p-4 border-b-1 border-light">
      ...
      <div className="w-full flex gap-4">
        <button className="flex-center flex-1 h-10  bg-white text-black border border-grey-normal rounded-md py-3 px-3 text-base">
          거절
        </button>
